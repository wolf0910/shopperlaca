...
if(isset($_FILES['file']['name']) && in_array($_FILES['file']['type'], $file_mimes)) {
    ...
    //check if phone exist
        $sql = "SELECT * FROM table_customer WHERE customer_phone = '".$sheetData[$i][2]."' ";
    ...
    //add to DB
        ...
        $sql5 = "INSERT INTO table_customer
        SET customer_fullname = '".$sheetData[$i][1]."',
            customer_phone = '".$sheetData[$i][2]."',
            customer_email = '".$sheetData[$i][3]."',
            customer_address = '".$sheetData[$i][4]."',
            customer_avatar = 'images/avatar/user-placeholder.png',
        ...
        if($result5){
            $txt_return .= 'Thêm khách hàng '.$sheetData[$i][1].' thành công ! <br>' ;
        } else {
            $txt_return .= 'Thêm khách hàng '.$sheetData[$i][1].' thất bại ! <br>' ;
        }
